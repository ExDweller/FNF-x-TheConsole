...
class StoryMenuState extends MusicBeatState
{
	...
	function updateText()
	{
		...
		{
			case 'parents-christmas':
				grpWeekCharacters.members[0].offset.set(310, 280);
			...
			case 'mom':
				grpWeekCharacters.members[0].offset.set(50, 200);
			...
			//Spamberries were too small :< made them bigger :>
			case 'spooky':
				grpWeekCharacters.members[0].offset.set(180, 100);

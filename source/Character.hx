	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false) {
		...
		switch (curCharacter) {
			...
			case 'bf':
				...
				addOffset('idle', -5, 0);
				addOffset("singUP", -45, 45);
				addOffset("singRIGHT", -45, -7);
				addOffset("singLEFT", 10, 0);
				addOffset("singDOWN", -40, -52);
				addOffset("singUPmiss", -45, 45);
				addOffset("singRIGHTmiss", -47, 0);
				addOffset("singLEFTmiss", 5, 0);
				addOffset("singDOWNmiss", -42, -48);
				addOffset("hey", 7, 4);
			...
			case 'parents-christmas':
				...
				addOffset("singDOWN", -31, -15);
				addOffset("singUP-alt", -55, 24);
				addOffset("singRIGHT-alt", -1, -24);
				addOffset("singLEFT-alt", -30, 18);
				addOffset("singDOWN-alt", -55, -30);
